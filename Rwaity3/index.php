        ...
        <div class="container">
            ...
            <div class="w-90 text-center p-5" style="margin: auto;">
                <div class="" role="group" aria-label="Basic example" >
                    <form action="" method="get">
                        <button type="submit" name="category" value="" class="btn btn-outline-dark">network</button>
                        <button type="submit" name="category" value="" class="btn btn-outline-dark">computer</button>
                        <button type="submit" name="category" value="" class="btn btn-outline-dark">program</button>
            ...
            <div class="row">
                ...
                <div class="card mb-4 box-shadow">
                                <img class="card-img-top" src="images/book.jpg" style="height: 450px; width: 100%; display: block;">
                                <div class="card-body">
                                    <small class="card-text"><b>Subject :PHP </b></small><br>
